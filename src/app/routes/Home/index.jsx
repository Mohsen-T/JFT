...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const wheatPriceData = await axios.get('https://api.coingecko.com/api/v3/coins/wheat-token');
      const wheatPrice = wheatPriceData.data.market_data.current_price.usd;
      setWheatPrice(wheatPrice);

      const wheatData = await axios.get('https://api.growthdefi.com/token/wheat');
      ...
      const wheatTVLData = await axios.get('https://api.growthdefi.com/tvl/wheat-tvl');
              ...
              <div className="et_pb_section et_pb_section_0 et_pb_section_parallax et_pb_with_background et_pb_fullwidth_section et_section_regular">
                <div className="et_parallax_bg_wrap">
                  <div
                    ...
                    style={{ backgroundImage: 'url("/assets/image/bg/crypto-bg-02.png")' }}
                  ></div>
                </div>
                    ...
                    <div className="header-content-container center">
                      <div className="header-content">
                        ...
                        <div className="et_pb_header_content_wrapper_home">
                          <p>
                            Go Jet is a decentralized ecosystem that focuses on capital efficiency
                            and maximising returns through a variety of products. The goal is to
                            maximise tokenholder value whilst maintaining the best yields and
                            products in the market. Go Jet is a multi chain ecosystem.
                          </p>
                        </div>
                        <a
                          className="et_pb_button et_pb_more_button et_pb_button_one"
                          href="https://docs.growthdefi.com/"
                          target="_blank"
                          rel="noreferrer"
                        >
                          ASSET DOCUMENTATION
                  ...
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    ...
                    <div className="et_pb_module et_pb_text et_pb_text_1  et_pb_text_align_center et_pb_bg_layout_dark">
                      <div className="et_pb_text_inner">
                        <p>
                          <span>
                            The Go Jet ecosystem utilises multiple assets in order to create a
                            sustainable environment. This allows users to spread their exposure as
                            well as create single or multiple revenue streams from their
                            investments.
                          </span>
                        </p>
                      </div>
              ...
              <div className="et_pb_section et_pb_section_2 et_pb_with_background et_section_regular">
                <FlexRow className="et_pb_row et_pb_row_2 jet-token-section">
                          ...
                          >
                            <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                              <span data-key="667f836fd7104675a2ba6164810fcb4b">
                                ...
                                it gets a share of the revenue from anything that is built.&nbsp;
                              </span>
                            </span>
                          </p>
                          <p
                          ...
                          >
                            <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                              <span data-key="c1f50bcf0d7a418db585a2b9529f553f">
                                JET can be staked for more JET (stkJET) or a passive BNB income.
                              </span>
                            </span>
                          </p>
                        </div>
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_0_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_0 et_pb_bg_layout_light" href="/jet">
                      ENTER JET
                    </a>
                  </div>
                </FlexRow>
                ...
                <div className="et_pb_row et_pb_row_4">
                  <div className="et_pb_column et_pb_column_2_3 et_pb_column_7  et_pb_css_mix_blend_mode_passthrough">
                    ...
                    <div className="et_pb_module et_pb_text et_pb_text_5  et_pb_text_align_left et_pb_bg_layout_dark">
                      <div className="et_pb_text_inner">
                        <p>
                          Go Jet is committed to creating a sustainable yield farming experience
                    ...
                    <div className="et_pb_with_border et_pb_module et_pb_blurb et_pb_blurb_3 et_animated  et_pb_text_align_left  et_pb_blurb_position_left et_pb_bg_layout_dark">
                      <div className="et_pb_blurb_content">
                        ...
                        <div className="et_pb_blurb_container">
                          ...
                          <div className="et_pb_blurb_description">
                            <p>
                              We are always adding new products and strategies to our environment.
                    ...
                    <div className="et_pb_with_border et_pb_module et_pb_blurb et_pb_blurb_4 et_animated  et_pb_text_align_left  et_pb_blurb_position_left et_pb_bg_layout_dark">
                      <div className="et_pb_blurb_content">
                        ...
                        <div className="et_pb_blurb_container">
                          ...
                          <div className="et_pb_blurb_description">
                            <p>
                              We understand that one token can’t do everything – not if you want a
                              sustainable ecosystem that can thrive as technology develops&nbsp; and
                              changes . All assets benefit the entire ecosystem.
                            </p>
                          </div>
                        </div>
                      </div>{' '}
                    ...
                    <div className="et_pb_with_border et_pb_module et_pb_blurb et_pb_blurb_5 et_animated  et_pb_text_align_left  et_pb_blurb_position_left et_pb_bg_layout_dark">
                      <div className="et_pb_blurb_content">
                        ...
                        <div className="et_pb_blurb_container">
                          ...
                          <div className="et_pb_blurb_description">
                            <p>
                              Our V1 strategy contracts have been been audited by{' '}
                              ...
                              safe and secure which can viewed at any time by anyone.&nbsp;&nbsp;
                            </p>
                          </div>
                        </div>
                      </div>{' '}
                    ...
                    <div className="et_pb_with_border et_pb_module et_pb_blurb et_pb_blurb_6 et_animated  et_pb_text_align_left  et_pb_blurb_position_left et_pb_bg_layout_dark">
                      <div className="et_pb_blurb_content">
                        ...
                        <div className="et_pb_blurb_container">
                          ...
                          <div className="et_pb_blurb_description">
                            <p>
                              We have developed several products during our time in the space and
                    ...
                    <div className="et_pb_with_border et_pb_module et_pb_blurb et_pb_blurb_7 et_animated  et_pb_text_align_left  et_pb_blurb_position_left et_pb_bg_layout_dark">
                      <div className="et_pb_blurb_content">
                        ...
                        <div className="et_pb_blurb_container">
                          ...
                          <div className="et_pb_blurb_description">
                            <p>
                              Rewards are distributed every block and there is no time lock when
                ...
                <div className="et_pb_row et_pb_row_8">
                  <div className="et_pb_column et_pb_column_1_2 et_pb_column_15  et_pb_css_mix_blend_mode_passthrough">
                    ...
                    <div className="et_pb_module et_pb_text et_pb_text_9  et_pb_text_align_left et_pb_bg_layout_dark">
                      <div className="et_pb_text_inner">
                        <p>
                          All our products are part of one ecosystem and they all contribute to it’s
                          sustainability. Through deposit and withdraw fee’s, performance fee’s,
                          buybacks, token burns, deflationary mechanics, incentives, treasuries and
                          auto compounding we ensure the longevity of the ecosystem and it’s
                          rewards.
                        </p>
                      </div>
                    </div>{' '}
                ...
                <div className="et_pb_with_border et_pb_row et_pb_row_10 et_pb_gutters2">
                  ...
                  <div className="et_pb_column et_pb_column_1_5 et_pb_column_18  et_pb_css_mix_blend_mode_passthrough">
                    ...
                    >
                      <div className="percent">
                        <p>
                          <span className="">{numberWithCommas(groMarketCap)}</span>
                  ...
                  <div className="et_pb_column et_pb_column_1_5 et_pb_column_20  et_pb_css_mix_blend_mode_passthrough">
                    ...
                    >
                      <div className="percent">
                        <p>
                          <span className="">{numberWithCommas(groSupply)}</span>
                          <span className="percent-sign" />
                        </p>
                      </div>
